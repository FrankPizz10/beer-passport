...
import { BackgroundColor, MainButtonColor, TitleColor, TryLikeButtonColor } from "../Styles/colors";
...
const BreweryScreen = (props: BreweryProps) => {
    ...
    const [breweryBeers, setBreweryBeers] = useState<BasicBeer[]>([] as BasicBeer[]);
